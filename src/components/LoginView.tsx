  ...
  return (
    <div className="w-screen h-screen flex bg-warm-bg overflow-hidden font-sans">
        ...
        <div className="my-auto py-10 max-w-sm w-full mx-auto">
          ...
          {errorMsg && (
            <motion.div 
              ...
              className="mb-5 p-3.5 bg-red-500/10 border border-red-200 rounded-xl flex items-start gap-2.5 text-xs text-red-700"
            >
      ...
      <div className="hidden lg:block lg:w-[60%] h-full relative bg-warm-bg">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-zinc-900/95 via-zinc-950/85 to-transparent"></div>
